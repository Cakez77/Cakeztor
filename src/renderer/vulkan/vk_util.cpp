...
u32 vk_get_memory_type_index(
    VkPhysicalDevice gpu,
    VkMemoryRequirements memRequirements,
    VkMemoryPropertyFlags memProps)
{
    u32 typeIdx = INVALID_IDX;
    ...
    for (u32 i = 0; i < gpuMemProps.memoryTypeCount; i++)
    {
...
//TODO: Implement
void vk_copy_to_buffer(Buffer *buffer, const void *data, u32 size)
{
